...
Our experienced and trained faculty members ensure a supportive learning environment that nurtures each student’s potential. We emphasize not only academic excellence but also personal development, discipline, and moral values to shape students into complete individuals. We believe that every student has unique talent, and with proper care and guidance, they can achieve outstanding results. Ideal Commerce College is fully dedicated to this mission — helping students grow academically, socially, and morally for a brighter future.`,
  ...
  return (
    <section className="w-full bg-[#f1f3f6] py-20 relative">
            ...
            <SwiperSlide key={item.id}>
              <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center min-h-[420px]">
                ...
                <div className="md:col-span-5 flex justify-center relative">
                  <div className="relative w-72 h-88 sm:w-80 sm:h-96">
                ...
                <div className="md:col-span-7 flex flex-col justify-center space-y-5">
                  {/* Quote Icon */}
                  <Quote className="w-12 h-12 text-blue-200 fill-blue-200" />

                  {/* Main Quote / Headline */}
                  <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-[#111827] leading-tight tracking-tight">
                    "{item.quote}"
                  </h2>
                  ...
                  <div>
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors group mt-2 pb-20"
                    >
                      Read Full Message
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-fadeIn">
          <div className="bg-white rounded-2xl max-w-2xl w-full p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed whitespace-pre-line">
              <p className="font-semibold text-gray-900 text-lg italic">
