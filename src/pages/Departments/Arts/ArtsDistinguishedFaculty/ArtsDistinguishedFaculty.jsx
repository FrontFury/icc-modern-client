...
import faculty1 from "../../../../assets/Esteemed Leaders/roksana-maam.jpg";
import faculty2 from "../../../../assets/Esteemed Leaders/Mehedi Hasan.png";
import faculty3 from "../../../../assets/Esteemed Leaders/sadita-maam.png";
import faculty4 from "../../../../assets/Esteemed Leaders/Robiul Hasan.png";

const ArtsDistinguishedFaculty = () => {
  const facultyMembers = [
    {
      id: 1,
      name: "UMME ROKSANA TABASSUM",
      role: "LECTURER (ECONOMICS)",
      email: "tabassum.etysha222@gmail.com",
      image: faculty1,
    },
    {
      id: 2,
      name: "MD. MEHEDI HASAN",
      role: "LECTURER (AGRICULTURE STUDIES)",
      email: "1706101mdmehedihasan@gmail.com",
      image: faculty2,
    },
    {
      id: 3,
      name: "HOMYRA SADIEA",
      role: "LECTURER (ISLAMIC HISTORY & CULTURE)",
      email: "homyrasadiea2018@gmail.com",
      image: faculty3,
    },
    {
      id: 4,
      name: "MD. ROBIUL HASAN",
      role: "LECTURER (CIVICS & GOOD GOVERNANCE)",
      email: "hasanrobi121@gmail.com",
      image: faculty4,
    },
  ];
